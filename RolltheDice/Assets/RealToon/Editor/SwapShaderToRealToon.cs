                    ...
                    if (ToBaInt == 0)
                    {
                        ...
                        if (ShaderName == "VRM/MToon" || ShaderName == "VRM10/MToon10")
                        {
                            ...
                            if (ShaRTURP)
                            {
                                ...
                                {
                                    m.SetFloat("_HighlightColorPower", 0.6f);
                                }
                            }
                            else if (ShaRTHDRP)
                            {
                            ...
                            else if (ShaRTBID)
                            {
                                ...
                                {
                                    m.SetColor("_MainColor", new Color(0.6886792f, 0.6886792f, 0.6886792f));
                                }
                            }
            ...
            EditorGUILayout.BeginHorizontal();
                EditorGUILayout.BeginVertical();
                    ...
                    EditorGUI.BeginDisabledGroup(FUL == true);
                        EnhaHiLighColInt = GUILayout.Toggle(EnhaHiLighColInt, "Enhance Light Highlight Color Intensity");
